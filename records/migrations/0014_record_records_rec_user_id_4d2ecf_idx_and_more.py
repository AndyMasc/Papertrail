...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='record',
            index=models.Index(fields=['user', '-last_edited'], name='records_rec_user_id_916bac_idx'),
        ),
        migrations.AddIndex(
            model_name='record',
            index=models.Index(fields=['user', 'record_type'], name='records_rec_user_id_20dcdf_idx'),
        ),
        migrations.AddIndex(
            model_name='record',
